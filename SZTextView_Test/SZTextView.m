...
@synthesize SZdelegate = _SZdelegate;
...
- (BOOL)becomeFirstResponder
{
	...
	if (self.SZdelegate && [self.SZdelegate respondsToSelector:@selector(textViewBecomeFirstResponder:)]) {
		[self.SZdelegate textViewBecomeFirstResponder:self];
	}
